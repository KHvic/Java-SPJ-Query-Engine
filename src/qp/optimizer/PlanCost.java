...
public class PlanCost {
	...
	protected int getStatistics(Join node) {
		...
		/**
		 * get size of the tuple in output & correspondigly calculate buffer
		...
		int outtuples = (int) Math
				.ceil(((double) lefttuples * righttuples) / (double) Math.max(leftattrdistn, rightattrdistn));
