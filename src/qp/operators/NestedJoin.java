		...
		while (!outbatch.isFull()) {
			...
			while (eosr == false) {
				...
				try {
					...
					// foreach tuple of leftbatch, foreach tuple of rightbatch,
					// if match -> output to outbatch
					for (i = lcurs; i < leftbatch.size(); i++) {
						for (j = rcurs; j < rightbatch.size(); j++) {
							...
							if (lefttuple.checkJoin(righttuple, leftindex, rightindex)) {
								...
								if (outbatch.isFull()) {
									if (i == leftbatch.size() - 1 && j == rightbatch.size() - 1) {// case
																									// 1
																									// cursor
																									// at
																									// end
										...
										lcurs = 0;
										rcurs = 0;
									} else if (i != leftbatch.size() - 1 && j == rightbatch.size() - 1) {// case
																											// 2
																											// right
																											// cursor
																											// at
